...
- `datasets_loader.py`: dataset loading and normalization for GSM8K and ToolMind `open_datasets`, plus the interleaved chat system prompt.
...
- `rewards.py`: GRPO-compatible reward functions for outcome correctness, conditional intermediate steps, TTFT, and efficiency.
